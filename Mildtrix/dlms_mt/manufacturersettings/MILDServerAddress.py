...
#
class MILDServerAddress:
    # pylint: disable=too-few-public-methods
    def __init__(self, address=HDLCAddressType.DEFAULT, value=0):
        """
        Constructor.

        address: HDLC address type.
        value: Physical address.
        """
        self.HDLCAddress = address
        self.physicalAddress = value
        self.formula = None
        self.logicalAddress = 0
        self.selected = False
