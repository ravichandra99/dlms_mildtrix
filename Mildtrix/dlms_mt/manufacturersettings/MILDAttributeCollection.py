...
# ---------------------------------------------------------------------------
from .MILDDLMSAttributeSettings import MILDDLMSAttributeSettings

class MILDAttributeCollection(list):
    #
    # Constructor.
    #
    ...
    def append(self, item):
        if not isinstance(item, MILDDLMSAttributeSettings):
            raise TypeError('item is not of type MILDDLMSAttributeSettings')
        super(MILDAttributeCollection, self).append(item)
        item.parent = self
