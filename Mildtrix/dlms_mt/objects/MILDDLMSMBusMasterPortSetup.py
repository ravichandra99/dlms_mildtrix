...
class MILDDLMSMBusMasterPortSetup(MILDDLMSObject, IMILDDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/Mildtrix.DLMS.Objects.MILDDLMSMBusMasterPortSetup
    """
    ...
    def __init__(self, ln=None, sn=0):
        ...
        """
        super(MILDDLMSMBusMasterPortSetup, self).__init__(ObjectType.MBUS_MASTER_PORT_SETUP, ln, sn)
