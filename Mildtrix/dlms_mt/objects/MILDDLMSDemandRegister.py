...
class MILDDLMSDemandRegister(MILDDLMSObject, IMILDDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/Mildtrix.DLMS.Objects.MILDDLMSDemandRegister
    """
    ...
    def __init__(self, ln=None, sn=0):
        ...
        """
        MILDDLMSObject.__init__(self, ObjectType.DEMAND_REGISTER, ln, sn)
    ...
    def isRead(self, index):
        if index == 4:
            return self.unit != 0
        return super(MILDDLMSDemandRegister, self).isRead(index)
    ...
    def getDataType(self, index):
        if index == 1:
            ...
            ret = super(MILDDLMSDemandRegister, self).getDataType(index)
        elif index == 3:
            ret = super(MILDDLMSDemandRegister, self).getDataType(index)
        elif index == 4:
            ret = DataType.ARRAY
