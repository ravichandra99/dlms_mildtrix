...
class MILDDLMSUtilityTables(MILDDLMSObject, IMILDDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/Mildtrix.DLMS.Objects.MILDDLMSUtilityTables
    """
    ...
    def __init__(self, ln="0.0.65.0.0.255", sn=0):
        ...
        """
        MILDDLMSObject.__init__(self, ObjectType.UTILITY_TABLES, ln, sn)
        # Table Id.
        self.tableId = 0
    ...
    def load(self, reader):
        ...
        self.buffer = MILDByteBuffer.hexToBytes(reader.readElementContentAsString("Buffer"))

    def save(self, writer):
        writer.writeElementString("Id", self.tableId, False)
        writer.writeElementString("Buffer", MILDByteBuffer.hex(self.buffer))
