...
class MILDDLMSLlcSscsSetup(MILDDLMSObject, IMILDDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/Mildtrix.DLMS.Objects.MILDDLMSLlcSscsSetup
    """
    ...
    def __init__(self, ln="0.0.28.0.0.255", sn=0):
        ...
        """
        MILDDLMSObject.__init__(self, ObjectType.LLC_SSCS_SETUP, ln, sn)
