...
class MILDDLMSData(MILDDLMSObject, IMILDDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/Mildtrix.DLMS.Objects.MILDDLMSData
    """
    ...
    def __init__(self, ln=None, sn=0):
        ...
        """
        MILDDLMSObject.__init__(self, ObjectType.DATA, ln, sn)
        self.value = None
    ...
    def getDataType(self, index):
        ...
        if index == 2:
            return super(MILDDLMSData, self).getDataType(index)
