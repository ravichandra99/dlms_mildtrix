...
# ---------------------------------------------------------------------------
class MILDObisValueItem:
    # pylint: disable=too-few-public-methods
    def __init__(self, devValue=None, userValue=None):
        """
        Constructor.

        devValue: Device value.
        userValue: Value that is shown to the user.
        """
        self.value = devValue
        self.uiValue = userValue
