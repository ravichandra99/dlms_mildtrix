...
#
class MILDDLMSSecureNotify(MILDDLMSNotify):
    #
    #      * Constructor.
    #      *
    ...
    def __init__(self, useLogicalNameReferencing, clientAddress, serverAddress, interfaceType):
        ...
        super(MILDDLMSSecureNotify, self).__init__(useLogicalNameReferencing, clientAddress, serverAddress, interfaceType)
        self.ciphering = MILDCiphering("ABCDEFGH".encode())
