...
class MILDDLMSSecureServer(MILDDLMSServer):
    ...
    def __init__(self, association, interfaceType):
        ...
        super(MILDDLMSSecureServer, self).__init__(association, interfaceType)
        self.settings.ciphering = MILDCiphering("ABCDEFGH".encode())
        self.kek = None
