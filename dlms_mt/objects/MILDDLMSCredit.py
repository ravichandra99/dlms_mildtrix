...
class MILDDLMSCredit(MILDDLMSObject, IMILDDLMSBase):
    """
    Online help:
    ...
    def __init__(self, ln="0.0.19.10.0.255", sn=0):
        ...
        """
        MILDDLMSObject.__init__(self, ObjectType.CREDIT, ln, sn)
    ...
    def getValue(self, settings, e):
        ...
        if e.index == 1:
            ...
            ret = MILDBitString.toBitString(self.creditConfiguration, 5)
        elif e.index == 8:
            ret = self.status
        elif e.index == 9:
