...
class MILDDLMSPrimeNbOfdmPlcMacFunctionalParameters(MILDDLMSObject, IMILDDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/Mildtrix.DLMS.Objects.MILDDLMSPrimeNbOfdmPlcMacFunctionalParameters
    """
    ...
    def __init__(self, ln="0.0.28.3.0.255", sn=0):
        ...
        """
        MILDDLMSObject.__init__(self, ObjectType.PRIME_NB_OFDM_PLC_MAC_FUNCTIONAL_PARAMETERS, ln, sn)
    ...
    def load(self, reader):
        ...
        self.sna = MILDByteBuffer.hexToBytes(reader.readElementContentAsString("SNa"))
