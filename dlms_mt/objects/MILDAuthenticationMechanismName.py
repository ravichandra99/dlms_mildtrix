...
class MILDAuthenticationMechanismName:
    # pylint: disable=too-many-instance-attributes,too-few-public-methods

    def __init__(self):
        # Constructor.
        self.mechanismId = Authentication.NONE
        self.jointIsoCtt = 2
        self.country = 16
        self.countryName = 756
        self.identifiedOrganization = 5
        self.dlmsUA = 8
        self.authenticationMechanismName = 2

    def __str__(self):
        return str(self.jointIsoCtt) + " " + str(self.country) + " " + str(self.countryName) + " " + \
            str(self.identifiedOrganization) + " " + str(self.dlmsUA) + " " + \
            str(self.authenticationMechanismName) + " " + str(self.mechanismId)
