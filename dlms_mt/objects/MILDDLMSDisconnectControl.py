...
class MILDDLMSDisconnectControl(MILDDLMSObject, IMILDDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/Mildtrix.DLMS.Objects.MILDDLMSDisconnectControl
    """
    ...
    def __init__(self, ln=None, sn=0):
        ...
        """
        MILDDLMSObject.__init__(self, ObjectType.DISCONNECT_CONTROL, ln, sn)
