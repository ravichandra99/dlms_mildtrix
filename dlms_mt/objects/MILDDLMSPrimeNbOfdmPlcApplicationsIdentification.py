...
class MILDDLMSPrimeNbOfdmPlcApplicationsIdentification(MILDDLMSObject, IMILDDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/Mildtrix.DLMS.Objects.MILDDLMSPrimeNbOfdmPlcApplicationsIdentification
    """
    ...
    def __init__(self, ln="0.0.28.7.0.255", sn=0):
        ...
        """
        MILDDLMSObject.__init__(self, ObjectType.PRIME_NB_OFDM_PLC_APPLICATIONS_IDENTIFICATION, ln, sn)
