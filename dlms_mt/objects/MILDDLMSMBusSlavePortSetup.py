...
class MILDDLMSMBusSlavePortSetup(MILDDLMSObject, IMILDDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/Mildtrix.DLMS.Objects.MILDDLMSMBusSlavePortSetup
    """
    ...
    def __init__(self, ln=None, sn=0):
        super(MILDDLMSMBusSlavePortSetup, self).__init__(ObjectType.MBUS_SLAVE_PORT_SETUP, ln, sn)
