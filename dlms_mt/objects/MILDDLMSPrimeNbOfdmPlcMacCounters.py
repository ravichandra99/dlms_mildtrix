...
class MILDDLMSPrimeNbOfdmPlcMacCounters(MILDDLMSObject, IMILDDLMSBase):
    """
    Online help:
    http://www.mildtrix.fi/Mildtrix.DLMS.Objects.MILDDLMSPrimeNbOfdmPlcMacCounters
    """
    ...
    def __init__(self, ln="0.0.28.4.0.255", sn=0):
        ...
        """
        MILDDLMSObject.__init__(self, ObjectType.PRIME_NB_OFDM_PLC_MAC_COUNTERS, ln, sn)
