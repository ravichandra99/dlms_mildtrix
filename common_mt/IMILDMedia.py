...
if MILDCommon.getVersion() >= (2, 7):
    class IMILDMedia(ABC):
        #pylint: disable=too-many-public-methods
        """Common interface for all Media components.
        Using this interface MILDCommunication library enables communication with\
        different medias."""
